 ...
 * authentication. This interface makes {@link org.jivesoftware.smack.SASLAuthentication} and
...
interface UserAuthentication {
     ...
     * @throws org.jivesoftware.smack.XMPPException if an error occurs while authenticating.
     */
     ...
     * @return the full JID provided by the server while binding a resource for the connection.
     * @throws org.jivesoftware.smack.XMPPException if an error occures while authenticating.
     */
