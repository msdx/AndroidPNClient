 ...
 * {@link #setInstance(org.jivesoftware.smack.provider.ProviderManager)} message. Trying to change the provider manager after
...
public class ProviderManager {
    ...
    /**
     * Returns the only ProviderManager valid instance.  Use {@link #setInstance(org.jivesoftware.smack.provider.ProviderManager)}
