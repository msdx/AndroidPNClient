 ...
 * use than a {@link org.jivesoftware.smack.PacketListener} when you need to wait for a specific
 * result.<p>
 *
 * Each packet collector will queue up to 2^16 packets for processing before
 * older packets are automatically dropped.
 *
 * @see org.jivesoftware.smack.Connection#createPacketCollector(org.jivesoftware.smack.filter.PacketFilter)
 * @author Matt Tucker
 */
