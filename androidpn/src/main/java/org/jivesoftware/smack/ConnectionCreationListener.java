...
/**
 * Implementors of this interface will be notified when a new {@link org.jivesoftware.smack.Connection}
 * has been created. The newly created connection will not be actually connected to
 * the server. Use {@link org.jivesoftware.smack.Connection#addConnectionCreationListener(org.jivesoftware.smack.ConnectionCreationListener)}
